...
#define USBD_DEVDESC_IDVENDOR       0x1209
#define USBD_DEVDESC_IDPRODUCT      0x7777
...
#define USBD_MSC_IF_NUM            (USBD_ADC_ENABLE*2+0+USBD_DFU_ENABLE)
#define USBD_CDC_ACM_CIF_NUM       (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+0+USBD_DFU_ENABLE)
#define USBD_CDC_ACM_DIF_NUM       (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+1+USBD_DFU_ENABLE)
#define USBD_HID_IF_NUM            (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+USBD_CDC_ACM_ENABLE*2+0+USBD_DFU_ENABLE)
#define USBD_DFU_IF_NUM            (USBD_ADC_ENABLE*2+0)
